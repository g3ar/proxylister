"""Strict loading and validation for CLI values and ``proxylister.conf``."""
...
from proxylister.paths import install_default_config, tool_home
...
def config_path() -> Path:
    return tool_home() / "proxylister.conf"
