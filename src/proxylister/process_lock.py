...
from proxylister.paths import database_path, lock_path, tool_home
...
class ProcessLock:
    ...
    def __enter__(self):
        try:
            ...
            raise AlreadyRunning(f"another proxylister process is already running in {tool_home()}{suffix}")
        metadata = {
            "pid": os.getpid(),
